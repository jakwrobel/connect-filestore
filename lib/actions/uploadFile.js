...
async function doStreamRequests(client, fileId, fileBuffer, fileSize) {
...
exports.process = async function process(msg, cfg) {
  ...
  const initialResponse = await doInitialRequest({client, resourceServerUrl: cfg.resourceServerUrl, apiKey: cfg.apiKey, tenantId: cfg.tenantId, accessToSet: access, source})
  ...
  this.logger.info(base64String)
  this.logger.info(base64Buffer)
  this.logger.info(fileSize)
  await doStreamRequests(client, fileId, base64Buffer, fileSize);
