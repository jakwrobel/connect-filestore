 ...
 */
async function doInitialRequest({apiKey, tenantId, resourceServerUrl, accessToSet, source}) {
...
exports.process = async function process(msg, cfg) {
  ...
  const fileId = await doInitialRequest({resourceServerUrl: cfg.resourceServerUrl, apiKey: cfg.apiKey, tenantId: cfg.tenantId, accessToSet: access, source})
