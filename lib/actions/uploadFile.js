...
async function doStreamRequests({
  ...
  for (let i = 0; i < numberOfChunks; i++) {
    ...
    externalThis.logger.info('this is the chunkStart', chunkStart)
    externalThis.logger.info('this is the chunkEnd', chunkEnd)
    externalThis.logger.info('this is the fileSize', fileSize)
