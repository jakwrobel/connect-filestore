...
exports.process = async function process(msg, cfg) {
  ...
  const { data, access, source, fileId } = msg?.body
  ...
  if (typeof fileId !== "string") {
    throw new Error(`msg.body.fileId is required and needs to be a string, the ${fileId} was received in the filestore Component`);
  }
